...
pub(crate) struct PreToolUseCommandInput {
    ...
    /// Ody extension: expose the active turn id to internal turn-scoped hooks.
    pub turn_id: String,
...
mod tests {
    ...
    #[test]
    fn turn_scoped_hook_inputs_include_ody_turn_id_extension() {
        // Ody intentionally diverges from Claude's public hook docs here so
