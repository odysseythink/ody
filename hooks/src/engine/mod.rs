...
use ody_protocol::protocol::HookTrustStatus;
...
pub(crate) struct ConfiguredHandler {
    pub event_name: ody_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            ody_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            ody_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            ody_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            ody_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            ody_protocol::protocol::HookEventName::PostCompact => "post-compact",
            ody_protocol::protocol::HookEventName::SessionStart => "session-start",
            ody_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            ody_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            ody_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            ody_protocol::protocol::HookEventName::Stop => "stop",
        }
    }
}
...
impl ClaudeHooksEngine {
    ...
    async fn maybe_spill_prompt_fragments(
        &self,
        session_id: ThreadId,
        fragments: Vec<ody_protocol::items::HookPromptFragment>,
    ) -> Vec<ody_protocol::items::HookPromptFragment> {
        self.output_spiller
