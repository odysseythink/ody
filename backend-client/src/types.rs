pub use ody_backend_openapi_models::models::ConfigBundleResponse;
pub use ody_backend_openapi_models::models::CreditStatusDetails;
pub use ody_backend_openapi_models::models::DeliveredConfigToml;
pub use ody_backend_openapi_models::models::DeliveredRequirementsToml;
pub use ody_backend_openapi_models::models::DeliveredTomlFragment;
pub use ody_backend_openapi_models::models::PaginatedListTaskListItem;
pub use ody_backend_openapi_models::models::PlanType;
pub use ody_backend_openapi_models::models::RateLimitReachedKind;
pub use ody_backend_openapi_models::models::RateLimitStatusDetails;
pub use ody_backend_openapi_models::models::RateLimitStatusPayload;
pub use ody_backend_openapi_models::models::RateLimitWindowSnapshot;
pub use ody_backend_openapi_models::models::SpendControlLimitDetails;
pub use ody_backend_openapi_models::models::TaskListItem;
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct OdyWorkspaceMessagesResponse {
    #[serde(default)]
    pub messages: Vec<OdyWorkspaceMessage>,
}

#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct OdyWorkspaceMessage {
    pub message_id: String,
    pub message_type: OdyWorkspaceMessageType,
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum OdyWorkspaceMessageType {
    Headline,
    Announcement,
    #[serde(other)]
    Unknown,
...
Second line"
    ...
    fn workspace_messages_response_deserializes_messages() {
        let response: OdyWorkspaceMessagesResponse = serde_json::from_value(serde_json::json!({
            "messages": [
                {
        ...
        assert_eq!(
            response,
            OdyWorkspaceMessagesResponse {
                messages: vec![
                    OdyWorkspaceMessage {
                        message_id: "headline-id".to_string(),
                        message_type: OdyWorkspaceMessageType::Headline,
                    ...
                    OdyWorkspaceMessage {
                        ...
                        message_type: OdyWorkspaceMessageType::Announcement,
                    ...
                    OdyWorkspaceMessage {
                        ...
                        message_type: OdyWorkspaceMessageType::Unknown,
