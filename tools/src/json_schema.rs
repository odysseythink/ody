...
/// separately.
/// See <https://developers.odysseythink.com/api/docs/guides/structured-outputs#supported-schemas>.
...
///
/// Definition tables must be objects. Ody keeps valid definition tables and
