...
fn build_request_plugin_install_elicitation_request_uses_expected_shape() {
    let connector = DiscoverableTool::Connector(Box::new(AppInfo {
        ...
        labels: None,
        install_url: Some(
            "https://example.com/apps/google-calendar/connector_2128aebfecb84f64a069897515042a44"
                .to_string(),
        ),
        is_accessible: false,
        is_enabled: true,
    ...
    assert_eq!(
        ...
        McpServerElicitationRequestParams {
            ...
            server_name: "ody-apps".to_string(),
            request: McpServerElicitationRequest::Form {
                meta: Some(json!(RequestPluginInstallMeta {
                    ody_approval_kind: REQUEST_PLUGIN_INSTALL_APPROVAL_KIND_VALUE,
...
fn build_request_plugin_install_elicitation_request_injects_plugin_metadata() {
    let plugin = DiscoverableTool::Plugin(Box::new(DiscoverablePluginInfo {
        id: "sample@odysseythink-curated-remote".to_string(),
        ...
        McpServerElicitationRequestParams {
            ...
            request: McpServerElicitationRequest::Form {
                meta: Some(json!(RequestPluginInstallMeta {
                    ...
                    tool_id: "sample@odysseythink-curated-remote",
...
fn build_request_plugin_install_meta_uses_expected_shape() {
    let connector = DiscoverableTool::Connector(Box::new(AppInfo {
        ...
        labels: None,
        install_url: Some(
            "https://example.com/apps/gmail/connector_68df038e0ba48191908c8434991bbac2".to_string(),
        ),
        is_accessible: false,
        is_enabled: true,
        plugin_display_names: Vec::new(),
    ...
    assert_eq!(
        ...
        RequestPluginInstallMeta {
            ...
            tool_name: "Gmail",
            install_url: Some(
                "https://example.com/apps/gmail/connector_68df038e0ba48191908c8434991bbac2"
            ),
            remote_plugin_id: None,
            app_connector_ids: None,
        },
