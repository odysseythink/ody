...
def build_plugin_json(plugin_name: str, *, with_mcp: bool, with_apps: bool) -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        ...
        "interface": {
            ...
            "shortDescription": f"Use {display_name} in Ody.",
            "longDescription": f"{display_name} adds a local Ody plugin scaffold.",
...
def main() -> None:
    ...
    plugin_json_path = plugin_root / ".ody-plugin" / "plugin.json"
    write_json(
        plugin_json_path,
