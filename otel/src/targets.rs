pub(crate) const OTEL_TARGET_PREFIX: &str = "ody_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "ody_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "ody_otel.trace_safe";
