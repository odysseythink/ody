...
use ody_app_server_protocol::RemoteControlDisableParams;
use ody_app_server_protocol::RemoteControlDisableResponse;
use ody_app_server_protocol::RemoteControlEnableParams;
...
async fn connect_with_retry(
    ...
    connect_timeout: Duration,
    connect_retry_delay: Duration,
) -> Result<WebSocketStream<ody_uds::UnixStream>> {
...
mod tests {
    ...
    const TEST_ODY_HOME: &str = "/tmp/ody-home";
        ...
        client::send_message(
            ...
            &JSONRPCMessage::Response(JSONRPCResponse {
                ...
                result: serde_json::json!({
                    "userAgent": "ody_app_server/1.2.3",
                    "odyHome": TEST_ODY_HOME,
                    "platformFamily": "unix",
                    "platformOs": "macos",
                }),
            }),
