...
const BASELINE_COMMIT_MESSAGE: &str =
    "Initialize Ody git baseline\n\nCo-authored-by: Ody <noreply@odysseythink.com>";
...
fn ody_signature() -> gix::actor::Signature {
    gix::actor::Signature {
        name: "Ody".into(),
        email: "noreply@odysseythink.com".into(),
        time: gix::date::Time {
