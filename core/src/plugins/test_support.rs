...
pub(crate) fn write_curated_plugin_sha(ody_home: &Path) {
...
pub(crate) fn write_plugins_feature_config(ody_home: &Path) {
    write_file(
...
pub(crate) async fn load_plugins_config(ody_home: &Path) -> crate::config::Config {
