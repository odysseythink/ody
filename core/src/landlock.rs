...
/// (ody-linux-sandbox), which defaults to bubblewrap for filesystem
    ...
    P: AsRef<Path>,
{
    ...
    let ody_linux_sandbox_exe = ody_linux_sandbox_exe.as_ref();
    ...
    let arg0 = if ody_linux_sandbox_exe
        .file_name()
        ...
        == Some(ODY_LINUX_SANDBOX_ARG0)
    {
        ...
        ody_linux_sandbox_exe.to_string_lossy().into_owned()
    } else {
        ODY_LINUX_SANDBOX_ARG0.to_string()
    };
    spawn_child_async(SpawnChildRequest {
        program: ody_linux_sandbox_exe.to_path_buf(),
        args,
        arg0: Some(&arg0),
        cwd: command_cwd,
