...
pub(super) async fn spawn_review_thread(
    ...
    let review_model_info = sess
        ...
        .await;
    // For reviews, disable Goals regardless of global settings.
    ...
    let unified_exec_shell_mode = UnifiedExecShellMode::for_session(
        ody_tools::unified_exec_feature_mode_for_features(review_features.get()),
    ...
    let extension_data = Arc::new(ody_extension_api::ExtensionData::new(
        review_turn_id.clone(),
    ));
