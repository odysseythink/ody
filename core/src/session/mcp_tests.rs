...
fn guardian_meta(tool_params: Option<Value>) -> Option<Meta> {
    let mut value = json!({
        "ody_approval_kind": "mcp_tool_call",
        "ody_request_type": "approval_request",
...
fn plugin_install_elicitation_telemetry_metadata_requires_install_tool_suggestion() {
    let event = EventMsg::ElicitationRequest(ElicitationRequestEvent {
        ...
        id: ody_protocol::mcp::RequestId::String("request-1".to_string()),
        request: ody_protocol::approvals::ElicitationRequest::Form {
            meta: Some(json!({
    ...
    let enable_event = EventMsg::ElicitationRequest(ElicitationRequestEvent {
        turn_id: Some("turn-1".to_string()),
        server_name: "ody_apps".to_string(),
        id: ody_protocol::mcp::RequestId::String("request-2".to_string()),
        request: ody_protocol::approvals::ElicitationRequest::Form {
            meta: Some(json!({
                "ody_approval_kind": "tool_suggestion",
                "suggest_type": "enable",
