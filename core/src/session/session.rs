...
pub(crate) struct SessionConfiguration {
    ...
    /// Directory containing all Ody state for this session.
    pub(super) ody_home: AbsolutePathBuf,
...
impl SessionConfiguration {
    ...
    pub(crate) fn ody_home(&self) -> &AbsolutePathBuf {
        &self.ody_home
    }
...
impl Session {
    ...
    pub(crate) async fn new(
        ...
        let thread_extension_data = ody_extension_api::ExtensionData::new_with_init(
            thread_id.to_string(),
        ...
        let session_result: anyhow::Result<Arc<Self>> = async {
            ...
            let trace_agent_path = session_configuration
                .session_source
                .get_agent_path()
                .unwrap_or_else(ody_protocol::AgentPath::root);
            let trace_task_name =
            ...
            let config_path = config.ody_home.join(CONFIG_TOML_FILE);
            ...
            let session_extension_data =
                ody_extension_api::ExtensionData::new(session_id.to_string());
            ...
            let session_start_source = match &initial_history {
                InitialHistory::Resumed(_) => ody_hooks::SessionStartSource::Resume,
                InitialHistory::New | InitialHistory::Forked(_) => {
                    ody_hooks::SessionStartSource::Startup
                }
                InitialHistory::Cleared => ody_hooks::SessionStartSource::Clear,
            };
