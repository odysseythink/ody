...
impl Session {
    ...
    pub(crate) fn make_turn_context(
        ...
        let unified_exec_shell_mode = UnifiedExecShellMode::for_session(
            ody_tools::unified_exec_feature_mode_for_features(per_turn_config.features.get()),
        ...
        let extension_data = Arc::new(ody_extension_api::ExtensionData::new(sub_id.clone()));
    ...
    async fn new_turn_context_from_configuration(
        ...
        let models_manager = self.services.models_manager.load();
        let model_info = models_manager
            .get_model_info(
                session_configuration.collaboration_mode.model(),
