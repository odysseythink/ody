...
use ody_shell_command::powershell::try_find_powershell_executable_blocking;
use ody_shell_command::powershell::try_find_pwsh_executable_blocking;
use serde_json::json;
...
async fn shell_command_pre_tool_use_payload_uses_raw_command() {
    ...
    let handler = ShellCommandHandler::from(ody_tools::ShellCommandBackendConfig::Classic);
