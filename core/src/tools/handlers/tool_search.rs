...
use ody_tools::TOOL_SEARCH_DEFAULT_LIMIT;
use ody_tools::TOOL_SEARCH_TOOL_NAME;
use ody_tools::ToolName;
use ody_tools::ToolSearchEntry;
use ody_tools::ToolSearchInfo;
use ody_tools::ToolSpec;
use ody_tools::coalesce_loadable_tool_specs;
use std::sync::Arc;
use std::sync::Mutex;
...
mod tests {
    ...
    fn mixed_search_results_coalesce_mcp_namespaces() {
        let dynamic_namespace = DynamicToolNamespaceSpec {
            ...
            description: "Tools in the ody_app namespace.".to_string(),
            tools: Vec::new(),
        };
