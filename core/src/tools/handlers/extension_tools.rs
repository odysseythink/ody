...
pub(crate) struct ExtensionToolAdapter(Arc<dyn ody_tools::ToolExecutor<ExtensionToolCall>>);

impl ExtensionToolAdapter {
    pub(crate) fn new(executor: Arc<dyn ody_tools::ToolExecutor<ExtensionToolCall>>) -> Self {
        Self(executor)
    }
}
    ...
    fn emit_completed<'a>(&'a self, item: ExtensionTurnItem) -> TurnItemEmissionFuture<'a> {
        Box::pin(async move {
            ...
            finalize_turn_item(
                ...
                &mut item,
                turn.collaboration_mode.mode == ody_protocol::config_types::ModeKind::Plan,
            )
            .await;
...
mod tests {
    ...
    impl ody_extension_api::ToolExecutor<ody_tools::ToolCall> for StubExtensionExecutor {
        fn tool_name(&self) -> ody_tools::ToolName {
            ody_tools::ToolName::plain("extension_echo")
        }
        ...
        fn spec(&self) -> ody_tools::ToolSpec {
            ody_tools::ToolSpec::Function(ody_tools::ResponsesApiTool {
                ...
                strict: true,
                parameters: ody_tools::parse_tool_input_schema(&json!({
                    "type": "object",
                    "properties": {
                        "message": { "type": "string" },
                    },
        ...
        fn handle(&self, _call: ody_tools::ToolCall) -> ody_tools::ToolExecutorFuture<'_> {
            Box::pin(async {
                Ok(
                    Box::new(ody_tools::JsonToolOutput::new(json!({ "ok": true })))
                        as Box<dyn ody_tools::ToolOutput>,
                )
            })
        }
    }
    ...
    struct CapturingExtensionExecutor {
        captured_call: Arc<Mutex<Option<ody_tools::ToolCall>>>,
    }

    impl ody_extension_api::ToolExecutor<ody_tools::ToolCall> for CapturingExtensionExecutor {
        fn tool_name(&self) -> ody_tools::ToolName {
            ody_tools::ToolName::plain("extension_echo")
        }
        ...
        fn handle(&self, call: ody_tools::ToolCall) -> ody_tools::ToolExecutorFuture<'_> {
    ...
    async fn exposes_generic_hook_payloads() {
        ...
        let invocation = ToolInvocation {
            ...
            tool_name: ody_tools::ToolName::plain("extension_echo"),
            source: ToolCallSource::Direct,
            payload: ToolPayload::Function {
                arguments: json!({ "message": "hello" }).to_string(),
            },
        };
        let output = ody_tools::JsonToolOutput::new(json!({ "ok": true }));
    ...
    impl ody_extension_api::ToolExecutor<ody_tools::ToolCall> for ImageGenerationExtensionExecutor {
        fn tool_name(&self) -> ody_tools::ToolName {
            ody_tools::ToolName::namespaced("image_gen", "imagegen")
        }
    ...
    async fn image_generation_publication_is_finalized_by_core() {
        ...
        let invocation = ToolInvocation {
            ...
            tool_name: ody_tools::ToolName::namespaced("image_gen", "imagegen"),
            source: ToolCallSource::Direct,
            payload: ToolPayload::Function {
                arguments: "{}".to_string(),
            },
