...
//!
//! `ody-rollout-trace` owns the event schema and writer behavior. This module
...
use ody_rollout_trace::ToolDispatchResult;
use ody_rollout_trace::ToolDispatchTraceContext;
...
fn tool_dispatch_invocation(invocation: &ToolInvocation) -> Option<ToolDispatchInvocation> {
    ...
    Some(ToolDispatchInvocation {
        ...
        ody_turn_id: invocation.turn.sub_id.clone(),
