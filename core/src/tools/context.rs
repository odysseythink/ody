...
use ody_protocol::models::function_call_output_content_items_to_text;
use ody_tools::LoadableToolSpec;
...
pub enum ToolCallSource {
    ...
    CodeMode {
        ...
        /// debugging the JS/runtime bridge, but it is not the Ody tool call id
