...
use ody_utils_output_truncation::approx_tokens_from_byte_count_i64;
...
impl ContextManager {
    ...
    pub(crate) fn for_prompt(mut self, input_modalities: &[InputModality]) -> Vec<ResponseItem> {
        ...
        tracing::info!(
            before_len,
            after_len = self.items.len(),
            "history::for_prompt normalized history"
        );
        self.items
    }
    ...
    fn normalize_history(&mut self, input_modalities: &[InputModality]) {
        ...
        tracing::info!(
            before_len,
            after_ensure_len = self.items.len(),
            "history::normalize_history after ensure_call_outputs_present"
        );
...
// See https://platform.odysseythink.com/docs/guides/images-vision#calculating-costs.
...
// See https://platform.odysseythink.com/docs/guides/images-vision#model-sizing-behavior.
