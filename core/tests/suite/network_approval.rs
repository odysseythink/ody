...
const NETWORK_TEST_HOST: &str = "ody-network-test.invalid";
const NETWORK_TEST_TARGET: &str = "http://ody-network-test.invalid:80";
...
async fn managed_network_unified_exec_test(server: &wiremock::MockServer) -> Result<TestOdy> {
