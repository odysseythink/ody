...
const REMOTE_MODEL: &str = "ody-test-ttl";
const VERSIONED_MODEL: &str = "ody-test-versioned";
const MISSING_VERSION_MODEL: &str = "ody-test-missing-version";
const DIFFERENT_VERSION_MODEL: &str = "ody-test-different-version";
...
async fn renews_cache_ttl_on_matching_models_etag() -> Result<()> {
    ...
    let cache_path = config.ody_home.join(CACHE_FILE);
