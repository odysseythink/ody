...
const REMOTE_CALENDAR_PLUGIN_CONFIG_ID: &str = "calendar@odysseythink-curated-remote";
const REMOTE_CALENDAR_PLUGIN_ID: &str = "plugin_calendar";
const CALENDAR_CONNECTOR_ID: &str = "calendar";
const CALENDAR_NAMESPACE: &str = "mcp__ody_apps__calendar";
...
async fn start_install_turn(test: &TestOdy, prompt: &str) -> Result<ElicitationRequestEvent> {
    ...
    Ok(wait_for_event_match(&test.ody, |event| match event {
...
async fn endpoint_mode_injects_candidates_hides_list_and_rejects_invented_ids() -> Result<()> {
            ...
            sse(vec![
                ...
                ev_function_call(
                    ...
                    &serde_json::to_string(&json!({
                        "plugin_id": "invented@odysseythink-curated-remote",
    ...
    assert!(contextual_user_message.contains("github@odysseythink-curated-remote"));
    assert!(contextual_user_message.contains("google-calendar@odysseythink-curated-remote"));
        ...
        vec![
            sse(vec![
                ...
                ev_function_call(
                    ...
                    REQUEST_PLUGIN_INSTALL_TOOL_NAME,
                    &serde_json::to_string(&json!({
                        "plugin_id": "github@odysseythink-curated-remote",
