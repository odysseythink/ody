use crate::test_ody::TestOdyBuilder;
use crate::test_ody::test_ody;
use anyhow::Result;
...
const ODY_APPS_META_KEY: &str = "_ody_apps";
const PROTOCOL_VERSION: &str = "2025-11-25";
const SERVER_NAME: &str = "ody-apps-test";
...
pub const DIRECT_CALENDAR_CREATE_EVENT_TOOL: &str = "mcp__ody_apps__calendar__create_event";
pub const DIRECT_CALENDAR_APP_ONLY_TOOL: &str = "mcp__ody_apps__calendar__app_only_action";
pub const DIRECT_CALENDAR_LIST_EVENTS_TOOL: &str = "mcp__ody_apps__calendar__list_events";
pub const DIRECT_CALENDAR_EXTRACT_TEXT_TOOL: &str = "mcp__ody_apps__calendar__extract_text";
pub const SEARCH_CALENDAR_NAMESPACE: &str = "mcp__ody_apps__calendar";
...
async fn mount_streamable_http_json_rpc(
    ...
    Mock::given(method("POST"))
        .and(path_regex("^/api/ody/apps/?$"))
        .respond_with(OdyAppsJsonRpcResponder {
            connector_name,
...
struct OdyAppsJsonRpcResponder {
    connector_name: String,
    connector_description: String,
    searchable: bool,
    include_app_only_tool: bool,
...
impl Respond for OdyAppsJsonRpcResponder {
        ...
        match method {
                        ...
                        "tools": [
                            {
                                ...
                                "_meta": {
                                    ...
                                    "odysseythink/outputTemplate": CALENDAR_CREATE_EVENT_MCP_APP_RESOURCE_URI,
                                    "_ody_apps": {
            ...
            "tools/call" => {
                ...
                let file_id = body
                    ...
                    .and_then(Value::as_str)
                    .unwrap_or_default();
                let ody_apps_meta = body.pointer("/params/_meta/_ody_apps").cloned();
