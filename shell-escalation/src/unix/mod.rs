...
//! `EscalateRequest` over the inherited `ODY_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `ODY_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use ody_protocol::approvals::EscalationPermissions;
pub use ody_protocol::approvals::ResolvedPermissionProfile;
