...
use ody_code_mode_protocol::CodeModeToolKind;
use ody_code_mode_protocol::DEFAULT_EXEC_YIELD_TIME_MS;
use ody_code_mode_protocol::ExecuteRequest;
use ody_code_mode_protocol::ExecuteToPendingOutcome;
use ody_code_mode_protocol::FunctionCallOutputContentItem;
use ody_code_mode_protocol::ImageDetail;
use ody_code_mode_protocol::RuntimeResponse;
...
// Re-exported for the test modules below, which import these future types
// via `super::` (they used to live next to the delegate in the parent).
#[cfg(test)]
        ...
        self.delegate
            .invoke_tool(
                CodeModeNestedToolCall {
                    ...
                    tool_name: ody_protocol::ToolName {
