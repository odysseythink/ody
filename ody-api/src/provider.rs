...
///
/// This is converted into a `RetryPolicy` used by `ody-client` to drive
...
mod tests {
    ...
    fn detects_azure_responses_base_urls() {
        let positive_cases = [
            "https://foo.odysseythink.azure.com/odysseythink",
            "https://foo.odysseythink.azure.us/odysseythink/deployments/bar",
            "https://foo.cognitiveservices.azure.cn/odysseythink",
            "https://foo.aoai.azure.com/odysseythink",
            "https://foo.odysseythink.azure-api.net/odysseythink",
        ...
        let negative_cases = [
            ...
            "https://example.com/odysseythink",
            "https://myproxy.azurewebsites.net/odysseythink",
        ];
