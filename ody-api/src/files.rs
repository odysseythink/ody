...
const OPENAI_FILE_USE_CASE: &str = "ody";
...
pub fn odysseythink_file_uri(file_id: &str) -> String {
    format!("{OPENAI_FILE_URI_PREFIX}{file_id}")
}

pub async fn upload_odysseythink_file(
    base_url: &str,
        ...
        match finalize_payload.status.as_str() {
            "success" => {
                return Ok(UploadedOpenAiFile {
                    ...
                    uri: odysseythink_file_uri(&create_payload.file_id),
...
mod tests {
    ...
    #[tokio::test]
    async fn upload_odysseythink_file_returns_canonical_uri() {
