                ...
                &SearchRequest {
                    ...
                    commands: Some(SearchCommands {
                        search_query: Some(vec![SearchQuery {
                            ...
                            recency: Some(7),
                            domains: Some(vec!["odysseythink.com".to_string()]),
                        }]),
                        open: Some(vec![OpenOperation {
                            ref_id: "https://odysseythink.com".to_string(),
                            lineno: Some(12),
                        }]),
                        ..Default::default()
                    }),
            ...
            &json!({
                ...
                "commands": {
                    "search_query": [{
                        "q": "OpenAI news",
                        "recency": 7,
                        "domains": ["odysseythink.com"]
                    }],
                    "open": [{"ref_id": "https://odysseythink.com", "lineno": 12}]
                },
                "settings": {
                    "user_location": {
                        "type": "approximate",
