...
impl<T: HttpTransport> ModelsClient<T> {
    ...
    fn append_client_version_query(req: &mut ody_client::Request, client_version: &str) {
...
mod tests {
    ...
    async fn appends_client_version_query() {
        ...
        let client = ModelsClient::new(
            transport.clone(),
            provider("https://example.com/api/ody"),
            Arc::new(DummyAuth),
        );
        ...
        assert_eq!(
            url,
            "https://example.com/api/ody/models?client_version=0.99.0"
        );
    }
