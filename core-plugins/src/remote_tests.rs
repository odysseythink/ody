...
fn recommended_plugins_are_validated_deduplicated_sorted_and_capped() {
    ...
    assert_eq!(
        ...
        Some(&RecommendedPlugin {
            config_id: "plugin-00@odysseythink-curated-remote".to_string(),
    ...
    assert_eq!(
        plugins.last(),
        Some(&RecommendedPlugin {
            config_id: "plugin-49@odysseythink-curated-remote".to_string(),
    ...
    assert_eq!(
        ...
        RecommendedPluginsMode::Endpoint {
            plugins: vec![RecommendedPlugin {
                config_id: "bounded@odysseythink-curated-remote".to_string(),
...
fn recommended_plugins_preserve_install_identity_and_normalize_app_ids() {
    ...
    assert_eq!(
        ...
        RecommendedPluginsMode::Endpoint {
            plugins: vec![RecommendedPlugin {
                config_id: "sample@odysseythink-curated-remote".to_string(),
