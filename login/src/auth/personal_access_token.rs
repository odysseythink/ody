...
const PROD_AUTHAPI_BASE_URL: &str = "https://auth.odysseythink.com/api/accounts";
const ODY_AUTHAPI_BASE_URL_ENV_VAR: &str = "ODY_AUTHAPI_BASE_URL";
...
impl PersonalAccessTokenAuth {
    pub(super) async fn load(
        ...
        let authapi_base_url = env::var(ODY_AUTHAPI_BASE_URL_ENV_VAR)
            .ok()
