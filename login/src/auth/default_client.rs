//! Default Ody HTTP client: shared `User-Agent`, `originator`, optional residency header, and
//! reqwest/`OdyHttpClient` construction.
//!
//! Use [`crate::default_client`] or [`ody_login::default_client`] from other crates in this
//! workspace.

use ody_client::BuildCustomCaTransportError;
use ody_client::BuildRouteAwareHttpClientError;
use ody_client::ClientRouteClass;
...
pub use ody_config::ResidencyRequirement;
