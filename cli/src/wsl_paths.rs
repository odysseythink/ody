...
mod tests {
    ...
    fn win_to_wsl_basic() {
        assert_eq!(
            win_path_to_wsl(r"C:\Temp\ody.zip").as_deref(),
            Some("/mnt/c/Temp/ody.zip")
        );
        assert_eq!(
            win_path_to_wsl("D:/Work/ody.tgz").as_deref(),
            Some("/mnt/d/Work/ody.tgz")
        );
        assert!(win_path_to_wsl("/home/user/ody").is_none());
    }
