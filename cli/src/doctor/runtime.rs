//! Captures how this Ody process was launched.
//!
...
/// Builds the process provenance row for the current Ody executable.
///
...
pub(super) fn search_check() -> DoctorCheck {
    ...
    if status != CheckStatus::Ok {
        check = check.remediation("Install ripgrep or repair the bundled Ody package.");
    }
    check
}
