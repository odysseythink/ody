use ody_app_server_protocol::CollabAgentState as ApiCollabAgentState;
use ody_app_server_protocol::CollabAgentStatus as ApiCollabAgentStatus;
use ody_app_server_protocol::CollabAgentTool;
use ody_app_server_protocol::CollabAgentToolCallStatus as ApiCollabAgentToolCallStatus;
use ody_app_server_protocol::CommandAction;
use ody_app_server_protocol::CommandExecutionSource;
use ody_app_server_protocol::CommandExecutionStatus as ApiCommandExecutionStatus;
use ody_app_server_protocol::ErrorNotification;
use ody_app_server_protocol::FileUpdateChange as ApiFileUpdateChange;
use ody_app_server_protocol::ItemCompletedNotification;
use ody_app_server_protocol::ItemStartedNotification;
use ody_app_server_protocol::McpToolCallError;
use ody_app_server_protocol::McpToolCallResult;
use ody_app_server_protocol::McpToolCallStatus as ApiMcpToolCallStatus;
use ody_app_server_protocol::PatchApplyStatus as ApiPatchApplyStatus;
use ody_app_server_protocol::PatchChangeKind as ApiPatchChangeKind;
...
use ody_exec::CollabToolCallItem;
use ody_exec::CollabToolCallStatus;
use ody_exec::CollectedThreadEvents;
use ody_exec::CommandExecutionItem;
use ody_exec::CommandExecutionStatus;
use ody_exec::ErrorItem;
use ody_exec::EventProcessorWithJsonOutput;
use ody_exec::ExecThreadItem;
use ody_exec::FileChangeItem;
use ody_exec::FileUpdateChange as ExecFileUpdateChange;
use ody_exec::ItemCompletedEvent;
use ody_exec::ItemStartedEvent;
use ody_exec::ItemUpdatedEvent;
use ody_exec::McpToolCallItem;
...
use ody_exec::ThreadErrorEvent;
use ody_exec::ThreadEvent;
use ody_exec::ThreadItemDetails;
use ody_exec::ThreadStartedEvent;
use ody_exec::TodoItem;
use ody_exec::TodoListItem;
use ody_exec::TurnCompletedEvent;
...
fn plan_update_emits_started_then_updated_then_completed() {
    ...
    assert_eq!(
        ...
        CollectedThreadEvents {
            ...
            status: OdyStatus::InitiateShutdown,
        }
    );
}
...
fn failed_turn_clears_stale_final_message() {
    ...
    assert_eq!(collected.status, OdyStatus::Running);
    ...
    assert_eq!(collected.status, OdyStatus::InitiateShutdown);
