...
fn failed_turn_does_not_overwrite_output_last_message_file() {
    ...
    let status = processor.process_server_notification(ServerNotification::TurnCompleted(
        ody_app_server_protocol::TurnCompletedNotification {
            ...
            turn: ody_app_server_protocol::Turn {
                ...
                error: Some(ody_app_server_protocol::TurnError {
    ...
    assert_eq!(status, OdyStatus::InitiateShutdown);
    ...
    let collected = processor.collect_thread_events(ServerNotification::ItemCompleted(
        ody_app_server_protocol::ItemCompletedNotification {
            item: ThreadItem::McpToolCall {
                ...
                arguments: json!({"search_query": [{"q": "odysseythink ody CLI documentation"}]}),
                app_context: None,
                mcp_app_resource_uri: None,
                plugin_id: None,
                result: Some(Box::new(ody_app_server_protocol::McpToolCallResult {
