...
async fn build_refresh_config(
    ...
    let mcp_servers = ody_mcp::configured_mcp_servers(&mcp_config);
...
mod tests {
    ...
    use ody_config::ThreadConfigContext;
    use ody_config::ThreadConfigLoadError;
    use ody_config::ThreadConfigLoadErrorCode;
    ...
    async fn refresh_config_uses_latest_auth_keyring_backend() -> anyhow::Result<()> {
        ...
        std::fs::write(
            temp_dir.path().join(ody_config::CONFIG_TOML_FILE),
            ...
            ThreadManager::new(
                ...
                thread_extensions(
                    ...
                    ThreadExtensionDependencies {
                        ...
                        goal_service: Arc::new(ody_goal_extension::GoalService::new()),
    ...
    impl ThreadConfigLoader for CountingThreadConfigLoader {
        fn load(
            &self,
            context: ThreadConfigContext,
        ) -> ody_config::ThreadConfigLoaderFuture<'_, Vec<ThreadConfigSource>> {
