    ...
    route_outgoing_envelope(
        ...
        OutgoingEnvelope::ToConnection {
            ...
            message: OutgoingMessage::Request(ServerRequest::CommandExecutionRequestApproval {
                ...
                params: ody_app_server_protocol::CommandExecutionRequestApprovalParams {
                    ...
                    additional_permissions: Some(
                        ody_app_server_protocol::AdditionalPermissionProfile {
                            network: None,
                            file_system: Some(
                                ody_app_server_protocol::AdditionalFileSystemPermissions {
