...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: ody_app_server_protocol::Thread,
...
pub(crate) struct ThreadState {
    ...
    listener_thread: Option<Weak<OdyThread>>,
    watch_registration: WatchRegistration,
}

impl ThreadState {
    pub(crate) fn listener_matches(&self, conversation: &Arc<OdyThread>) -> bool {
