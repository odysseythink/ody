    ...
    async fn exec_one_off_command_inner(
        ...
        let (
            ...
            let file_system_sandbox_policy =
                ody_protocol::permissions::FileSystemSandboxPolicy::from_legacy_sandbox_policy_for_cwd(&policy, &sandbox_cwd);
            let network_sandbox_policy =
                ody_protocol::permissions::NetworkSandboxPolicy::from(&policy);
            let permission_profile =
                ody_protocol::models::PermissionProfile::from_runtime_permissions_with_enforcement(
                    ody_protocol::models::SandboxEnforcement::from_legacy_sandbox_policy(&policy),
        ...
        let linux_sandbox_exe = self.arg0_paths.ody_linux_sandbox_exe.clone();
        ...
        let exec_request = ody_core::exec::build_exec_request(
            exec_params,
            &effective_permission_profile,
            &sandbox_cwd,
