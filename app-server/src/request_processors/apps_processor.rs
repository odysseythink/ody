...
impl AppsRequestProcessor {
    ...
    async fn apps_list_task(
        ...
        let should_retry = result
            .as_ref()
            .is_ok_and(|(_, ody_apps_ready)| !ody_apps_ready);
        outgoing
        ...
        if should_retry && !retry_params.force_refetch {
            ...
            .await
            {
                warn!("failed to refresh app list after ody-apps readiness retry: {err:?}");
            }
        }
    }
        ...
        loop {
            ...
            match result {
                AppListLoadResult::Accessible(Ok(status)) => {
                    ...
                    ody_apps_ready = status.ody_apps_ready;
                }
            ...
            if accessible_loaded && all_loaded {
                ...
                return Ok((response, ody_apps_ready));
            }
        }
    }
