...
use ody_protocol::protocol::AdditionalContextEntry as CoreAdditionalContextEntry;
use ody_protocol::protocol::AdditionalContextKind as CoreAdditionalContextKind;
...
impl TurnRequestProcessor {
    ...
    fn review_request_from_target(
        ...
        let hint = ody_core::review_prompts::user_facing_hint(&core_target);
    ...
    async fn build_thread_settings_overrides(
    ...
    ) -> Result<ody_protocol::protocol::ThreadSettingsOverrides, JSONRPCErrorError> {
        ...
        if has_any_overrides {
            thread
                .preview_thread_settings_overrides(OdyThreadSettingsOverrides {
        ...
        Ok(ody_protocol::protocol::ThreadSettingsOverrides {
            environments,
    ...
    async fn thread_settings_update_inner(
        ...
        if thread_settings != ody_protocol::protocol::ThreadSettingsOverrides::default() {
            self.submit_core_op(
                request_id,
                thread.as_ref(),
                ...
                let (message, data, error_type) = match err {
                    ...
                    SteerInputError::ActiveTurnNotSteerable { turn_kind } => {
                        let (message, turn_steer_error) = match turn_kind {
                            ody_protocol::protocol::NonSteerableTurnKind::Review => (
                                "cannot steer a review turn".to_string(),
                                TurnSteerRequestError::NonSteerableReview,
                            ),
                            ody_protocol::protocol::NonSteerableTurnKind::Compact => (
    ...
    async fn prepare_realtime_conversation_thread(
        ...
        request_id: &ConnectionRequestId,
        thread_id: &str,
    ) -> Result<Option<(ThreadId, Arc<OdyThread>)>, JSONRPCErrorError> {
    ...
    async fn thread_realtime_start_inner(
        ...
        self.submit_core_op(
            ...
            Op::RealtimeConversationStart(ConversationStartParams {
                ...
                ody_responses_as_items: params.ody_responses_as_items.unwrap_or(false),
