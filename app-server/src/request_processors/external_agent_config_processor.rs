...
use ody_analytics::ExternalAgentConfigImportCompletedInput;
use ody_analytics::ExternalAgentConfigImportFailureInput;
use ody_app_server_protocol::CommandMigration;
...
use ody_app_server_protocol::ExternalAgentConfigImportHistoriesReadResponse;
use ody_app_server_protocol::ExternalAgentConfigImportHistory;
use ody_app_server_protocol::ExternalAgentConfigImportItemTypeFailure as ProtocolImportFailure;
use ody_app_server_protocol::ExternalAgentConfigImportItemTypeSuccess as ProtocolImportSuccess;
use ody_app_server_protocol::ExternalAgentConfigImportParams;
use ody_app_server_protocol::ExternalAgentConfigImportProgressNotification;
use ody_app_server_protocol::ExternalAgentConfigImportResponse;
use ody_app_server_protocol::ExternalAgentConfigImportTypeResult as ProtocolImportTypeResult;
use ody_app_server_protocol::ExternalAgentConfigMigrationItem;
use ody_app_server_protocol::ExternalAgentConfigMigrationItemType;
use ody_app_server_protocol::HookMigration;
use ody_app_server_protocol::JSONRPCErrorError;
use ody_app_server_protocol::McpServerMigration;
use ody_app_server_protocol::MigrationDetails;
use ody_app_server_protocol::PluginsMigration;
use ody_app_server_protocol::ServerNotification;
use ody_arg0::Arg0DispatchPaths;
use ody_core::ThreadManager;
use ody_external_agent_sessions::ExternalAgentSessionMigration as CoreSessionMigration;
use ody_rollout::StateDbHandle;
use ody_state::ExternalAgentConfigImportFailureRecord;
use ody_state::ExternalAgentConfigImportSuccessRecord;
...
impl ExternalAgentConfigRequestProcessor {
    pub(crate) fn new(args: ExternalAgentConfigRequestProcessorArgs) -> Self {
        ...
        Self {
            outgoing,
            migration_service: ExternalAgentConfigService::new(ody_home),
            session_importer,
            thread_manager,
            config_processor,
            state_db,
                ...
                .map(|migration_item| ExternalAgentConfigMigrationItem {
                    ...
                    details: migration_item.details.map(|details| MigrationDetails {
                        ...
                        sessions: details
                            .sessions
                            .into_iter()
                            .map(|session| ody_app_server_protocol::SessionMigration {
                                path: session.path,
                                cwd: session.cwd,
                                title: session.title,
                            })
                        ...
                        subagents: details
                            .subagents
                            .into_iter()
                            .map(|subagent| ody_app_server_protocol::SubagentMigration {
                                name: subagent.name,
                            })
                            .collect(),
                        commands: details
...
fn protocol_import_history(
    record: ody_state::ExternalAgentConfigImportHistoryRecord,
