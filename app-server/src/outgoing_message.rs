...
use ody_otel::span_w3c_trace_context;
...
pub(crate) use ody_app_server_transport::OutgoingError;
...
mod tests {
    ...
    fn verify_model_rerouted_notification_serialization() {
        let notification = ServerNotification::ModelRerouted(ModelReroutedNotification {
            ...
            from_model: "gpt-5.3-ody".to_string(),
    ...
    async fn send_response_routes_to_target_connection() {
        ...
        let outgoing =
            OutgoingMessageSender::new(tx, ody_analytics::AnalyticsEventsClient::disabled());
        ...
        outgoing
            .send_response(
                ...
                ClientResponsePayload::ThreadArchive(
                    ody_app_server_protocol::ThreadArchiveResponse {},
                ),
            )
            .await;
