...
pub struct RawTraceEvent {
    ...
    pub ody_turn_id: Option<OdyTurnId>,
...
pub enum RawTraceEventPayload {
    ...
    InferenceCancelled {
        ...
        /// before Ody stopped consuming the stream.
        upstream_request_id: Option<String>,
        /// Why Ody stopped consuming the provider stream before a terminal response event.
        reason: String,
    ...
    ToolCallRuntimeStarted {
        tool_call_id: ToolCallId,
        /// Runtime/protocol observation for how Ody began executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallRuntimeEnded {
        tool_call_id: ToolCallId,
        status: ExecutionStatus,
        /// Runtime/protocol observation for how Ody finished executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallEnded {
        tool_call_id: ToolCallId,
