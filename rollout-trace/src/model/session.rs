...
/// One Ody thread/session participating in the rollout.
///
...
/// Provenance for a traced Ody thread.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// One activation of the Ody runtime for one thread.
///
/// A Ody turn groups protocol/runtime work for one thread activation.
