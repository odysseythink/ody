...
/// Process/session ID returned by Ody's terminal runtime.
...
/// Canonical reduced graph for one Ody rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the Ody rollout/session being observed. `trace_id`
    ...
    pub ody_turns: BTreeMap<OdyTurnId, OdyTurn>,
