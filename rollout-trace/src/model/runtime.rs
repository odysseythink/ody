...
/// Runtime operation requested by the model, a JS code cell, or Ody itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_ody_turn_id: Option<OdyTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the Ody tool boundary.
    ///
    ...
    /// they describe how Ody executed the request, not what the caller sent.
