//! Trace bundle format, writer, and reducer for Ody rollouts.
//!
//! This crate owns the trace schema. Hot-path Ody code should depend on the
...
/// Shared recorder context for inference attempts within one Ody turn.
...
pub use thread::ODY_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical Ody tool boundary.
...
/// Append-only writer used by hot-path Ody instrumentation.
