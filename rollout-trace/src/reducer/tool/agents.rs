...
use ody_protocol::protocol::CollabCloseBeginEvent;
use ody_protocol::protocol::CollabCloseEndEvent;
...
pub(in crate::reducer) struct ObservedAgentResultEdge {
    ...
    pub(in crate::reducer) child_ody_turn_id: String,
        ...
        self.rollout
            ...
            .filter(|item| {
                item.thread_id == thread_id
                    && item.ody_turn_id.as_deref() == Some(ody_turn_id)
