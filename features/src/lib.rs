...
pub enum Feature {
    ...
    Chronicle,
    /// Compress request bodies (zstd) when sending streaming requests to ody-backend.
    ...
    /// Prompt Ody Apps connector auth failures through MCP URL elicitations.
    AuthElicitation,
    ...
    match feature {
        ...
        _ => {
            ...
            let details = if alias == canonical {
                ...
                Some(format!(
                    "Enable it with `--enable {canonical}` or `[features].{canonical}` in config.toml. See https://developers.odysseythink.com/ody/config-basic#feature-flags for details."
                ))
            };
            (summary, details)
        }
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            name: "Memories",
            menu_description: "Allow Ody to create new memories from conversations and bring relevant memories into new conversations.",
            announcement: "NEW: Ody can now generate and use memories. Try it now with `/memories`",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            announcement: "NEW: Network proxy can now be enabled from /experimental. Restart Ody after enabling it.",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: if cfg!(any(
            ...
            Stage::Experimental {
                ...
                menu_description: "Keep your computer awake while Ody is running a thread.",
