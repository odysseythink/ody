...
const RESOURCE_URI: &str = "memo://ody/example-note";

fn stdio_server_bin() -> Result<PathBuf, CargoBinError> {
    ody_utils_cargo_bin::cargo_bin("test_stdio_server")
}
...
fn init_params() -> InitializeRequestParams {
    ...
    InitializeRequestParams::new(
        capabilities,
        Implementation::new("ody-test", "0.0.0-test").with_title("Ody rmcp resource test"),
    )
