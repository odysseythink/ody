...
const OPENAI_FORM_METHOD: &str = "odysseythink/form";
...
pub(crate) struct ElicitationClientService {
    ...
    supports_odysseythink_form: bool,
...
impl ElicitationClientService {
    pub(crate) fn new(
        ...
        let supports_odysseythink_form = client_info
            .capabilities
            .extensions
            .as_ref()
...
mod tests {
    ...
    fn parses_odysseythink_form_custom_requests() {
        ...
        .expect("valid odysseythink/form request");
