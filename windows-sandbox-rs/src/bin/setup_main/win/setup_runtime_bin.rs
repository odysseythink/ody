...
pub(super) fn ensure_ody_app_runtime_paths_readable(
    ...
    let ody_root = local_app_data.join("OpenAI").join("Ody");

    for runtime_path in [ody_root.join("bin"), ody_root.join("runtimes")] {
