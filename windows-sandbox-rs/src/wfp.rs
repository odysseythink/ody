...
const SESSION_NAME: &str = "Ody Windows Sandbox WFP";
const PROVIDER_NAME: &str = "Ody Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Ody Windows sandbox filters";
const SUBLAYER_NAME: &str = "Ody Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Ody Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are Ody-owned identities; do not regenerate them unless we
...
/// Installs the persistent Ody WFP filters for `account`.
///
...
/// Ensures the persistent Ody WFP provider exists.
...
/// Ensures the persistent Ody sublayer exists under the Ody provider.
