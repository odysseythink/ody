...
const SETUP_BIN: &str = "ody-windows-sandbox-setup";
const SETUP_MANIFEST: &str = "ody-windows-sandbox-setup.manifest";
...
fn main() -> Result<(), String> {
    ...
    // Keep this scoped to the setup helper so Ody binaries that link the
