    ...
    while let Some(event) = incoming_rx.recv().await {
        ...
        match event {
            ...
            JsonRpcConnectionEvent::Message(message) => match message {
                ody_app_server_protocol::JSONRPCMessage::Request(request) => {
                ...
                ody_app_server_protocol::JSONRPCMessage::Notification(notification) => {
                ...
                ody_app_server_protocol::JSONRPCMessage::Response(response) => {
                    warn!(
                ...
                ody_app_server_protocol::JSONRPCMessage::Error(error) => {
                    warn!(
