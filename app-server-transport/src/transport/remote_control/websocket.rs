...
const REMOTE_CONTROL_SUBSCRIBE_CURSOR_HEADER: &str = "x-ody-subscribe-cursor";
...
fn build_remote_control_websocket_request(
    ...
    set_remote_control_header(headers, "x-ody-server-id", &enrollment.server_id)?;
