use crate::default_client::OdyHttpClient;
use crate::default_client::OdyRequestBuilder;
...
impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: OdyHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<OdyRequestBuilder, TransportError> {
