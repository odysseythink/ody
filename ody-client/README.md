...
Generic transport layer that wraps HTTP requests, retries, and streaming primitives without any Ody/OpenAI awareness.
...
- Consumed by higher-level crates like `ody-api`; it stays neutral on endpoints, headers, or API-specific error shapes.
