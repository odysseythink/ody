//! Shared model metadata types exchanged between Ody services and clients.
//!
...
/// See https://platform.odysseythink.com/docs/guides/reasoning?api-mode=responses#get-started-with-reasoning
...
pub enum InputModality {
    ...
    Image,
    /// Audio attachments included in user turns or tool results.
    Audio,
    /// Video attachments included in user turns or tool results.
    Video,
}
...
/// Metadata describing a Ody-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the Ody backend `/models` endpoint.
