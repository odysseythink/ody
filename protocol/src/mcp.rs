...
//! `schemars`) so they can be embedded in Ody's own protocol structures.
...
// === Adapter helpers ===
//
// These types and conversions intentionally live in `ody-protocol` so other crates can convert
