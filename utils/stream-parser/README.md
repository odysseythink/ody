# ody-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and Ody did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust Ody on it. Feel free to update the documentation as you
modify the code
...
```rust
use ody_utils_stream_parser::CitationStreamParser;
use ody_utils_stream_parser::StreamTextParser;
...
```rust
use ody_utils_stream_parser::CitationStreamParser;
use ody_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), ody_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use ody_utils_stream_parser::InlineHiddenTagParser;
use ody_utils_stream_parser::InlineTagSpec;
use ody_utils_stream_parser::StreamTextParser;
