//! Helpers for truncating tool and exec output using [`TruncationPolicy`](ody_protocol::protocol::TruncationPolicy).

use ody_protocol::models::FunctionCallOutputContentItem;
pub use ody_utils_string::approx_bytes_for_tokens;
pub use ody_utils_string::approx_token_count;
pub use ody_utils_string::approx_tokens_from_byte_count;
