...
use ody_rollout::first_rollout_content_match_snippet;
use ody_rollout::parse_cursor;
use ody_rollout::search_rollout_matches;
...
pub(super) async fn search_threads(
    ...
    loop {
        ...
        for item in page.items {
            let logical_path = ody_rollout::plain_rollout_path(item.path.as_path());
