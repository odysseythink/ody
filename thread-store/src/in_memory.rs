...
use ody_rollout::persisted_rollout_items;
...
fn git_info_from_patch(patch: &ThreadMetadataPatch) -> Option<ody_protocol::protocol::GitInfo> {
    ...
    Some(ody_protocol::protocol::GitInfo {
