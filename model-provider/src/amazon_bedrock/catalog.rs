...
use ody_model_provider_info::AMAZON_BEDROCK_GPT_5_5_MODEL_ID;
use ody_model_provider_info::AMAZON_BEDROCK_GPT_5_6_LUNA_MODEL_ID;
use ody_model_provider_info::AMAZON_BEDROCK_GPT_5_6_SOL_MODEL_ID;
use ody_model_provider_info::AMAZON_BEDROCK_GPT_5_6_TERRA_MODEL_ID;
...
fn gpt_5_bedrock_model(odysseythink_slug: &str, bedrock_slug: &str, priority: i32) -> ModelInfo {
    let mut model = bundled_odysseythink_model(odysseythink_slug);
...
fn bundled_odysseythink_model(slug: &str) -> ModelInfo {
