...
//! managed ODY_HOME cache, while custom pets remain entirely user-owned data
//! under `$ODY_HOME/pets/<pet-id>/pet.json` or legacy avatar directories.
//!
...
pub(crate) const DEFAULT_PET_ID: &str = "ody";
