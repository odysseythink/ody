...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("chat", "Chat", "toggle_reasoning_expansion", "Expand or collapse the most recent reasoning block."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("chat", "toggle_reasoning_expansion") => Some(&mut keymap.chat.toggle_reasoning_expansion),
...
pub(super) fn bindings_for_action<'a>(
    ...
    match (context, action) {
        ...
        ("chat", "toggle_reasoning_expansion") => Some(runtime_keymap.chat.toggle_reasoning_expansion.as_slice()),
