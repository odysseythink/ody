...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("chat", "toggle_history_cell_expansion") => Some(&mut keymap.chat.toggle_history_cell_expansion),
        ("chat", "open_history_cell_overlay") => Some(&mut keymap.chat.open_history_cell_overlay),
...
pub(super) fn bindings_for_action<'a>(
    ...
    match (context, action) {
        ...
        ("chat", "toggle_history_cell_expansion") => Some(runtime_keymap.chat.toggle_history_cell_expansion.as_slice()),
        ("chat", "open_history_cell_overlay") => Some(runtime_keymap.chat.open_history_cell_overlay.as_slice()),
