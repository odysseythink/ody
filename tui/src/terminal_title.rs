...
//! "leave the old title alone" or "clear the title Ody last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Ody manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Ody started managing the title.
