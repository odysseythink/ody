...
where
    T: DeserializeOwned,
{
    from_app_server_wire(ody_app_server_protocol::SessionSource::Cli)
}
...
where
    T: DeserializeOwned,
{
    from_app_server_wire(ody_app_server_protocol::SkillScope::User)
}
...
where
    T: DeserializeOwned,
{
    from_app_server_wire(ody_app_server_protocol::SkillScope::Repo)
}
