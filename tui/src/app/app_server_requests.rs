...
mod tests {
    ...
    use ody_app_server_protocol::PermissionGrantScope;
    ...
    fn rejects_permissions_with_paths_that_cannot_be_localized() {
        ...
        let permissions = ody_app_server_protocol::RequestPermissionProfile {
            network: None,
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
        ...
        let permissions = pending
            .take_resolution(&Op::RequestPermissionsResponse {
                id: "perm-1".to_string(),
                response: ody_protocol::request_permissions::RequestPermissionsResponse {
                    ...
                    scope: ody_protocol::request_permissions::PermissionGrantScope::Session,
        ...
        assert_eq!(
            ...
            PermissionsRequestApprovalResponse {
                permissions: ody_app_server_protocol::GrantedPermissionProfile {
                    ...
                    file_system: Some(AdditionalFileSystemPermissions {
                        ...
                        glob_scan_max_depth: None,
                        entries: Some(vec![
                            ody_app_server_protocol::FileSystemSandboxEntry {
                                path: ody_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(read_path).into(),
                                },
                                access: ody_app_server_protocol::FileSystemAccessMode::Read,
                            },
                            ody_app_server_protocol::FileSystemSandboxEntry {
                                path: ody_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(write_path).into(),
                                },
                                access: ody_app_server_protocol::FileSystemAccessMode::Write,
                            },
                        ]),
                    }),
                },
    ...
    fn rejects_dynamic_tool_calls_as_unsupported() {
        ...
        let unsupported = pending
            .note_server_request(&ServerRequest::DynamicToolCall {
                ...
                params: ody_app_server_protocol::DynamicToolCallParams {
                    thread_id: "thread-1".to_string(),
                    turn_id: "turn-1".to_string(),
    ...
    fn does_not_mark_chatgpt_auth_refresh_as_unsupported() {
        ...
        assert_eq!(
            pending.note_server_request(&ServerRequest::ChatgptAuthTokensRefresh {
                ...
                params: ody_app_server_protocol::ChatgptAuthTokensRefreshParams {
                    reason: ody_app_server_protocol::ChatgptAuthTokensRefreshReason::Unauthorized,
