...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::App => "continue this session in Ody Desktop",
            SlashCommand::Quit | SlashCommand::Exit => "exit Ody",
            SlashCommand::Copy => "copy last response as markdown",
            SlashCommand::Raw => "toggle raw scrollback mode for copy-friendly terminal selection",
            SlashCommand::Diff => "show git diff (including untracked files)",
            SlashCommand::Mention => "mention a file",
            SlashCommand::Skills => "use skills to improve how Ody performs specific tasks",
            ...
            SlashCommand::Flows => "list flow skill runs and their progress",
            ...
            SlashCommand::Permissions => "choose what Ody is allowed to do",
