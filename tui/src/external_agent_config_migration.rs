...
mod tests {
    ...
    use ody_app_server_protocol::PluginsMigration;
    use ody_app_server_protocol::SessionMigration;
    use pretty_assertions::assert_eq;
    use ratatui::layout::Rect;
    use std::path::PathBuf;

    fn sample_plugin_details() -> ody_app_server_protocol::MigrationDetails {
        ody_app_server_protocol::MigrationDetails {
            plugins: vec![
                PluginsMigration {
    ...
    fn sample_items() -> Vec<ExternalAgentConfigMigrationItem> {
        ...
        vec![
            ExternalAgentConfigMigrationItem {
                ...
                description:
                    "Migrate /Users/alex/.claude/settings.json into /Users/alex/.ody/config.toml"
                        .to_string(),
                cwd: None,
                details: None,
            },
            ExternalAgentConfigMigrationItem {
                ...
                cwd: None,
                details: Some(ody_app_server_protocol::MigrationDetails {
