        ...
        ApprovedExecpolicyAmendment {
            ...
            (
                ...
                vec![
                    actor.subject().into(),
                    "approved".bold(),
                    " ody to always run commands that start with ".into(),
                    snippet,
                ],
            )
        }
        ...
        Abort => match subject {
            ...
            ApprovalDecisionSubject::NetworkAccess { target } => (
                ...
                vec![
                    actor.subject().into(),
                    "canceled".bold(),
                    " the request for ody network access to ".into(),
                    Span::from(target).dim(),
                ],
            ),
        },
