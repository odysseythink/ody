...
impl HistoryCell for UpdateAvailableHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            line![
                "See ",
                "https://github.com/odysseythink/ody".cyan().underlined(),
        ...
        let content = text![
            line![
                ...
                " ",
                format!("{ODY_CLI_VERSION} -> {}", self.latest_version).bold(),
            ],
            update_instruction,
            "",
            "See full release notes:",
            "https://github.com/odysseythink/ody/releases/latest"
                .cyan()
                .underlined(),
        ];
    ...
    fn raw_lines(&self) -> Vec<Line<'static>> {
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            "See https://github.com/odysseythink/ody for installation options.".to_string()
        };
        vec![
            Line::from("Update available!"),
            Line::from(format!("{ODY_CLI_VERSION} -> {}", self.latest_version)),
            Line::from(update_instruction),
            Line::from(""),
            Line::from("See full release notes:"),
            Line::from("https://github.com/odysseythink/ody/releases/latest"),
        ]
    }
...
const TRUSTED_ACCESS_FOR_CYBER_URL: &str =
    "https://help.odysseythink.com/en/articles/trusted-access-for-cyber";
