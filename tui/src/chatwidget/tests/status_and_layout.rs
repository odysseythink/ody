...
async fn status_line_git_summary_items_render_values() {
    ...
    chat.status_line_git_summary = Some(StatusLineGitSummary {
        pull_request: Some(crate::branch_summary::StatusLinePullRequest {
            number: 20_252,
            url: "https://github.com/odysseythink/ody/pull/20252".to_string(),
        }),
...
async fn configured_pet_load_is_deferred_until_after_construction() {
    ...
    crate::pets::write_test_pack(&cfg.ody_home);
...
async fn rate_limit_snapshots_keep_separate_entries_per_limit_id() {
    ...
    let ody = chat
        .rate_limit_snapshots_by_limit_id
        .get("ody")
        .expect("ody snapshot should exist");
    let other = chat
        .rate_limit_snapshots_by_limit_id
        .get("ody_other")
        .expect("ody_other snapshot should exist");

    assert_eq!(ody.primary.as_ref().map(|w| w.used_percent), Some(20.0));
    assert_eq!(
        ody
            .credits
            .as_ref()
...
async fn account_update_clears_derived_usage_limit_state_and_prompt() {
    ...
    assert!(chat.ody_rate_limit_reached_type.is_some());
    assert!(matches!(
        chat.rate_limit_switch_prompt,
        RateLimitSwitchPromptState::Shown
    ));
    ...
    assert_eq!(chat.ody_rate_limit_reached_type, None);
    assert!(matches!(
        chat.rate_limit_switch_prompt,
        RateLimitSwitchPromptState::Idle
    ));
...
async fn esc_interrupt_pauses_active_goal_turn() {
    ...
    assert_matches!(rx.try_recv(), Ok(AppEvent::OdyOp(Op::Interrupt { .. })));
    assert_goal_paused_event(&mut rx, thread_id);
...
fn update_thread_goal(chat: &mut ChatWidget, thread_id: ThreadId, status: AppThreadGoalStatus) {
    ...
    chat.handle_server_notification(
        ServerNotification::ThreadGoalUpdated(
            ody_app_server_protocol::ThreadGoalUpdatedNotification {
                thread_id,
                turn_id: None,
                goal,
            },
...
async fn ambient_pet_stays_hidden_until_a_pet_is_selected() {
    ...
    crate::pets::write_test_pack(&chat.config.ody_home);
    chat.set_tui_pet(Some("ody".to_string()));
...
async fn interrupted_turn_clears_visible_running_hook() {
    ...
    handle_hook_started(
        ...
        hook_started_run(
            ...
            ody_app_server_protocol::HookEventName::PreToolUse,
...
async fn completed_turn_clears_visible_running_hook() {
    ...
    handle_hook_started(
        ...
        hook_started_run(
            ...
            ody_app_server_protocol::HookEventName::PostToolUse,
            /*status_message*/ None,
        ),
    );
    reveal_running_hooks(&mut chat);
...
async fn terminal_title_model_updates_on_model_change_without_manual_refresh() {
    ...
    assert_eq!(chat.last_terminal_title, Some("gpt-5.3-ody".to_string()));
}
...
async fn status_line_model_with_reasoning_updates_on_mode_switch_without_manual_refresh() {
    ...
    assert_eq!(
        status_line_text(&chat),
        Some("gpt-5.3-ody high".to_string())
    );
    ...
    assert_eq!(
        status_line_text(&chat),
        Some("gpt-5.3-ody medium".to_string())
    );
...
async fn renamed_thread_footer_title_snapshot() {
    ...
    chat.handle_server_notification(
        ServerNotification::ThreadNameUpdated(
            ody_app_server_protocol::ThreadNameUpdatedNotification {
                thread_id: thread_id.to_string(),
        ...
        ServerNotification::ThreadGoalUpdated(
            ody_app_server_protocol::ThreadGoalUpdatedNotification {
                ...
                goal: test_thread_goal(
                    ody_app_server_protocol::ThreadGoalStatus::Active,
                    /*token_budget*/ Some(50_000),
                    /*tokens_used*/ 40_000,
                ),
            },
...
async fn status_line_goal_complete_elapsed_footer_snapshot() {
    ...
    chat.refresh_status_line();
    let mut goal = test_thread_goal(
        ody_app_server_protocol::ThreadGoalStatus::Complete,
        /*token_budget*/ None,
        /*tokens_used*/ 40_000,
    );
...
async fn thread_goal_update_for_other_thread_is_ignored() {
    ...
    let mut goal = test_thread_goal(
        ody_app_server_protocol::ThreadGoalStatus::BudgetLimited,
        /*token_budget*/ Some(50_000),
        /*tokens_used*/ 50_000,
    );
...
fn goal_status_indicator_formats_statuses_and_budgets() {
    ...
    assert_eq!(
        goal_status_indicator_from_app_goal(&test_thread_goal(
            ody_app_server_protocol::ThreadGoalStatus::Blocked,
            /*token_budget*/ None,
            /*tokens_used*/ 0,
        )),
    ...
    assert_eq!(
        goal_status_indicator_from_app_goal(&test_thread_goal(
            ody_app_server_protocol::ThreadGoalStatus::UsageLimited,
            /*token_budget*/ None,
            /*tokens_used*/ 0,
        )),
...
fn test_thread_goal(
    status: ody_app_server_protocol::ThreadGoalStatus,
    token_budget: Option<i64>,
    tokens_used: i64,
) -> ody_app_server_protocol::ThreadGoal {
    ody_app_server_protocol::ThreadGoal {
        thread_id: "thread-1".to_string(),
    ...
    chat.handle_server_notification(
        ServerNotification::HookStarted(AppServerHookStartedNotification {
            ...
            run: AppServerHookRunSummary {
                ...
                source: ody_app_server_protocol::HookSource::User,
                display_order: 0,
...
async fn completed_hook_with_no_entries_stays_out_of_history() {
    ...
    handle_hook_completed(
        ...
        hook_completed_run(
            "post-tool-use:0:/tmp/hooks.json",
            ody_app_server_protocol::HookEventName::PostToolUse,
            ody_app_server_protocol::HookRunStatus::Completed,
            Vec::new(),
        ),
    );
...
async fn blocked_and_failed_hooks_render_feedback_and_errors() {
    ...
    handle_hook_completed(
        ...
        hook_completed_run(
            "pre-tool-use:0:/tmp/hooks.json",
            ody_app_server_protocol::HookEventName::PreToolUse,
            ody_app_server_protocol::HookRunStatus::Blocked,
            vec![ody_app_server_protocol::HookOutputEntry {
                kind: ody_app_server_protocol::HookOutputEntryKind::Feedback,
    ...
    handle_hook_completed(
        ...
        hook_completed_run(
            ...
            ody_app_server_protocol::HookEventName::PostToolUse,
            ody_app_server_protocol::HookRunStatus::Failed,
            vec![ody_app_server_protocol::HookOutputEntry {
                kind: ody_app_server_protocol::HookOutputEntryKind::Error,
...
async fn completed_same_id_hook_output_survives_restart() {
    ...
    handle_hook_started(
        ...
        hook_started_run(
            hook_id,
            ody_app_server_protocol::HookEventName::Stop,
    ...
    handle_hook_completed(
        ...
        hook_completed_run(
            hook_id,
            ody_app_server_protocol::HookEventName::Stop,
            ody_app_server_protocol::HookRunStatus::Stopped,
            vec![ody_app_server_protocol::HookOutputEntry {
                kind: ody_app_server_protocol::HookOutputEntryKind::Stop,
...
async fn hook_completed_before_reveal_renders_completed_without_running_flash() {
    ...
    handle_hook_started(
        ...
        hook_started_run(
            ...
            ody_app_server_protocol::HookEventName::SessionStart,
    ...
    handle_hook_completed(
        ...
        hook_completed_run(
            ...
            ody_app_server_protocol::HookRunStatus::Completed,
            vec![ody_app_server_protocol::HookOutputEntry {
                kind: ody_app_server_protocol::HookOutputEntryKind::Context,
...
fn hook_started_run(
    id: &str,
    event_name: ody_app_server_protocol::HookEventName,
    status_message: Option<&str>,
) -> ody_app_server_protocol::HookRunSummary {
    hook_run_summary(
        id,
        event_name,
        ody_app_server_protocol::HookRunStatus::Running,
        status_message,
        Vec::new(),
    )
}
...
fn hook_completed_run(
    id: &str,
    event_name: ody_app_server_protocol::HookEventName,
    status: ody_app_server_protocol::HookRunStatus,
    entries: Vec<ody_app_server_protocol::HookOutputEntry>,
) -> ody_app_server_protocol::HookRunSummary {
    hook_run_summary(
...
fn hook_run_summary(
    ...
    ody_app_server_protocol::HookRunSummary {
        id: id.to_string(),
        event_name,
        handler_type: ody_app_server_protocol::HookHandlerType::Command,
        execution_mode: ody_app_server_protocol::HookExecutionMode::Sync,
        scope: ody_app_server_protocol::HookScope::Turn,
        source_path: PathBuf::from(test_path_display("/tmp/hooks.json")).abs(),
        source: ody_app_server_protocol::HookSource::User,
        display_order: 0,
        status,
        ...
        started_at: 1,
        completed_at: (status != ody_app_server_protocol::HookRunStatus::Running).then_some(2),
        duration_ms: (status != ody_app_server_protocol::HookRunStatus::Running).then_some(1),
        entries,
    }
}
...
async fn chatwidget_exec_and_status_layout_vt100_snapshot() {
    ...
    handle_exec_begin(
        ...
        AppServerThreadItem::CommandExecution {
            id: "c1".into(),
            command: ody_shell_command::parse_command::shlex_join(&command),
            cwd: cwd.clone().into(),
            process_id: None,
