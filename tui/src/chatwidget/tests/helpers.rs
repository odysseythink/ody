...
pub(super) async fn test_config() -> Config {
    ...
    let ody_home = tempfile::Builder::new()
        .prefix("chatwidget-tests-")
        .tempdir()
        .expect("tempdir")
        .keep();
    let mut config =
        Config::load_default_with_cli_overrides_for_ody_home(ody_home.clone(), Vec::new())
            .await
            .expect("config");
    config.ody_home = ody_home.abs();
    config.sqlite_home = ody_home.clone();
    config.log_dir = ody_home.join("log");
...
fn token_usage_breakdown(usage: TokenUsage) -> ody_app_server_protocol::TokenUsageBreakdown {
    ody_app_server_protocol::TokenUsageBreakdown {
        ...
        Some(info) => {
            chat.handle_server_notification(
                ServerNotification::ThreadTokenUsageUpdated(
                    ody_app_server_protocol::ThreadTokenUsageUpdatedNotification {
                        ...
                        token_usage: ody_app_server_protocol::ThreadTokenUsage {
...
pub(super) fn handle_error(
    ...
    ody_error_info: Option<OdyErrorInfo>,
) {
    chat.handle_server_notification(
...
pub(super) fn begin_exec_with_source(
    ...
    let command_actions = ody_shell_command::parse_command::parse_command(&command)
        .into_iter()
...
pub(super) fn terminal_interaction(
    ...
    chat.handle_server_notification(
        ServerNotification::TerminalInteraction(
            ody_app_server_protocol::TerminalInteractionNotification {
                thread_id: thread_id(chat),
                turn_id: chat
                    .turn_lifecycle
                    .last_turn_id
...
pub(super) fn plugins_test_detail(
    ...
    description: Option<&str>,
    skills: &[&str],
    hooks: &[(ody_app_server_protocol::HookEventName, usize)],
    apps: &[&str],
    mcp_servers: &[&str],
) -> PluginDetail {
    PluginDetail {
...
pub(super) async fn assert_hook_events_snapshot(
    ...
    handle_hook_completed(
        ...
        hook_run(
            ...
            status_message,
            vec![
                ody_app_server_protocol::HookOutputEntry {
                    kind: ody_app_server_protocol::HookOutputEntryKind::Warning,
...
fn hook_event_label(event_name: ody_app_server_protocol::HookEventName) -> &'static str {
    match event_name {
        ody_app_server_protocol::HookEventName::PreToolUse => "PreToolUse",
        ody_app_server_protocol::HookEventName::PermissionRequest => "PermissionRequest",
        ody_app_server_protocol::HookEventName::PostToolUse => "PostToolUse",
        ody_app_server_protocol::HookEventName::PreCompact => "PreCompact",
        ody_app_server_protocol::HookEventName::PostCompact => "PostCompact",
        ody_app_server_protocol::HookEventName::SessionStart => "SessionStart",
        ody_app_server_protocol::HookEventName::UserPromptSubmit => "UserPromptSubmit",
        ody_app_server_protocol::HookEventName::SubagentStart => "SubagentStart",
        ody_app_server_protocol::HookEventName::SubagentStop => "SubagentStop",
        ody_app_server_protocol::HookEventName::Stop => "Stop",
    }
}
