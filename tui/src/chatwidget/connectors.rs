...
impl ChatWidget {
    ...
    pub(super) fn connectors_enabled(&self) -> bool {
        self.config.features.enabled(Feature::Apps) && self.api_key_configured
    }
    ...
    fn connectors_popup_params(
        ...
        for connector in connectors {
            let connector_label = ody_connectors::metadata::connector_display_label(connector);
            ...
            let instructions = if connector.is_accessible {
                ...
                "Install this app in your browser, then reload Ody."
            };
