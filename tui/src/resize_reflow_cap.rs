...
//! the fallback bucket.
//!
//! These caps are deliberately conservative: Ody is rebuilding normal terminal scrollback, not an
...
use ody_config::types::DEFAULT_TERMINAL_RESIZE_REFLOW_FALLBACK_MAX_ROWS;
