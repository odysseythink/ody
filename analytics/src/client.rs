...
impl AnalyticsEventsDestination {
    ...
    fn from_base_url_and_capture_file(base_url: String, capture_file: Option<PathBuf>) -> Self {
        ...
        Self::Http {
            url: format!("{base_url}/ody/analytics-events/events"),
        }
    }
}
...
impl AnalyticsEventsClient {
    ...
    pub fn track_compaction(&self, event: crate::facts::OdyCompactionEvent) {
        self.record_fact(AnalyticsFact::Custom(CustomAnalyticsFact::Compaction(
            Box::new(event),
        )));
    }

    pub fn track_goal_event(&self, event: OdyGoalEvent) {
    ...
    pub fn track_turn_ody_error(&self, fact: TurnOdyErrorFact) {
        self.record_fact(AnalyticsFact::Custom(CustomAnalyticsFact::TurnOdyError(
            Box::new(fact),
        )));
    }
