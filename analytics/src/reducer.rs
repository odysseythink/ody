...
use crate::events::OdyCollabAgentToolCallEventParams;
use crate::events::OdyCollabAgentToolCallEventRequest;
...
use crate::events::OdyGoalEventRequest;
use crate::events::OdyHookRunEventRequest;
use crate::events::OdyImageGenerationEventParams;
use crate::events::OdyImageGenerationEventRequest;
use crate::events::OdyMcpToolCallEventParams;
use crate::events::OdyMcpToolCallEventRequest;
use crate::events::OdyOnboardingExternalAgentImportCompleteEventRequest;
use crate::events::OdyOnboardingExternalAgentImportCompleteMetadata;
...
use crate::events::OdyTurnEventParams;
...
impl<'a> AnalyticsDropSite<'a> {
    ...
    fn compaction(input: &'a OdyCompactionEvent) -> Self {
        Self {
    ...
    fn goal(input: &'a OdyGoalEvent) -> Self {
        Self {
            event_name: "goal",
            thread_id: &input.thread_id,
    ...
    fn tool_item(
        notification: &'a ody_app_server_protocol::ItemCompletedNotification,
        item_id: &'a str,
    ) -> Self {
        Self {
...
struct CompletedTurnState {
    ...
    turn_error: Option<OdyErrorInfo>,
    completed_at: u64,
...
impl AnalyticsReducer {
    pub(crate) async fn ingest(&mut self, input: AnalyticsFact, out: &mut Vec<TrackEventRequest>) {
        match input {
            ...
            AnalyticsFact::Custom(input) => match input {
                ...
                CustomAnalyticsFact::TurnOdyError(input) => {
                    self.ingest_turn_ody_error(*input);
                }
    ...
    fn ingest_guardian_review(
        ...
        out.push(TrackEventRequest::GuardianReview(Box::new(
            GuardianReviewEventRequest {
                event_type: "ody_guardian_review",
    ...
    fn ingest_turn_ody_error(&mut self, input: TurnOdyErrorFact) {
        let TurnOdyErrorFact {
            turn_id,
            thread_id,
            error,
        } = input;
        ...
        turn_state.ody_error = Some(error);
    }
    ...
    fn ingest_app_mentioned(&mut self, input: AppMentionedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.extend(mentions.into_iter().map(|mention| {
            let event_params = ody_app_metadata(&tracking, mention);
            TrackEventRequest::AppMentioned(OdyAppMentionedEventRequest {
    ...
    fn ingest_app_used(&mut self, input: AppUsedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        let event_params = ody_app_metadata(&tracking, app);
        out.push(TrackEventRequest::AppUsed(OdyAppUsedEventRequest {
    ...
    fn ingest_hook_run(&mut self, input: HookRunInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.push(TrackEventRequest::HookRun(OdyHookRunEventRequest {
            event_type: "ody_hook_run",
            event_params: ody_hook_run_metadata(&tracking, hook),
        }));
    }
    ...
    fn ingest_plugin_used(&mut self, input: PluginUsedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.push(TrackEventRequest::PluginUsed(OdyPluginUsedEventRequest {
            event_type: "ody_plugin_used",
            event_params: ody_plugin_used_metadata(&tracking, plugin),
        }));
    }
    ...
    fn ingest_plugin_state_changed(
        ...
        let event = OdyPluginEventRequest {
    ...
    fn ingest_external_agent_config_import_completed(
        ...
        out.push(TrackEventRequest::ExternalAgentConfigImportCompleted(
            OdyOnboardingExternalAgentImportCompleteEventRequest {
                event_type: "ody_onboarding_external_agent_import_complete",
                event_params: OdyOnboardingExternalAgentImportCompleteMetadata {
            ...
            ServerNotification::TurnCompleted(notification) => {
                ...
                turn_state.completed = Some(CompletedTurnState {
                    ...
                    turn_error: notification
                        .turn
                        .error
                        .and_then(|error| error.ody_error_info),
    ...
    fn ingest_compaction(&mut self, input: OdyCompactionEvent, out: &mut Vec<TrackEventRequest>) {
        let Some((connection_state, thread_metadata)) =
        ...
        out.push(TrackEventRequest::Compaction(Box::new(
            OdyCompactionEventRequest {
                event_type: "ody_compaction_event",
                event_params: ody_compaction_event_params(
                    input,
    ...
    fn ingest_goal(&mut self, input: OdyGoalEvent, out: &mut Vec<TrackEventRequest>) {
        let Some((connection_state, thread_metadata)) =
            self.thread_context_or_warn(AnalyticsDropSite::goal(&input))
        else {
            return;
        };
        out.push(TrackEventRequest::Goal(Box::new(OdyGoalEventRequest {
            event_type: "ody_goal_event",
            event_params: ody_goal_event_params(
                input,
                thread_metadata.session_id.clone(),
                connection_state.app_server_client.clone(),
                connection_state.runtime.clone(),
    ...
    fn ingest_guardian_review_completed(
        &mut self,
        notification: ody_app_server_protocol::ItemGuardianApprovalReviewCompletedNotification,
        out: &mut Vec<TrackEventRequest>,
    ) {
    ...
    fn emit_turn_steer_event(
        ...
        out.push(TrackEventRequest::TurnSteer(OdyTurnSteerEventRequest {
            event_type: "ody_turn_steer_event",
            event_params: OdyTurnSteerEventParams {
    ...
    fn emit_review_event(
        ...
        out.push(TrackEventRequest::ReviewEvent(OdyReviewEventRequest {
    ...
    async fn maybe_emit_turn_event(&mut self, turn_id: &str, out: &mut Vec<TrackEventRequest>) {
        ...
        let turn_event = TrackEventRequest::TurnEvent(Box::new(OdyTurnEventRequest {
            event_type: "ody_turn_event",
            event_params: ody_turn_event_params(
                connection_state.app_server_client.clone(),
                connection_state.runtime.clone(),
                turn_id.to_string(),
                turn_state,
    ...
    match item {
        ThreadItem::CommandExecution {
            ...
            Some(TrackEventRequest::CommandExecution(
                OdyCommandExecutionEventRequest {
        ...
        ThreadItem::FileChange {
            ...
            Some(TrackEventRequest::FileChange(OdyFileChangeEventRequest {
                event_type: "ody_file_change_event",
                event_params: OdyFileChangeEventParams {
                    base,
        ...
        ThreadItem::DynamicToolCall {
            ...
            Some(TrackEventRequest::DynamicToolCall(
                OdyDynamicToolCallEventRequest {
                    event_type: "ody_dynamic_tool_call_event",
                    event_params: OdyDynamicToolCallEventParams {
                        base,
        ...
        ThreadItem::CollabAgentToolCall {
            ...
            Some(TrackEventRequest::CollabAgentToolCall(
                OdyCollabAgentToolCallEventRequest {
                    event_type: "ody_collab_agent_tool_call_event",
                    event_params: OdyCollabAgentToolCallEventParams {
                        base,
        ...
        ThreadItem::ImageGeneration {
            ...
            Some(TrackEventRequest::ImageGeneration(
                OdyImageGenerationEventRequest {
                    event_type: "ody_image_generation_event",
                    event_params: OdyImageGenerationEventParams {
                        base,
...
fn guardian_review_subject_metadata(
    ...
    match action {
        ...
        GuardianApprovalReviewAction::DatabaseWrite { connection, .. } => (
...
fn file_change_counts(changes: &[ody_app_server_protocol::FileUpdateChange]) -> FileChangeCounts {
...
fn ody_turn_event_params(
    ...
    let ody_error = turn_state.ody_error.as_ref();
    OdyTurnEventParams {
        thread_id,
        session_id: thread_metadata.session_id.clone(),
        turn_id,
        ...
        ody_error_kind: ody_error.map(|error| error.kind),
        ody_error_http_status_code: ody_error.and_then(|error| error.http_status_code),
...
fn analytics_turn_status(status: ody_app_server_protocol::TurnStatus) -> Option<TurnStatus> {
    match status {
        ody_app_server_protocol::TurnStatus::Completed => Some(TurnStatus::Completed),
        ody_app_server_protocol::TurnStatus::Failed => Some(TurnStatus::Failed),
        ody_app_server_protocol::TurnStatus::Interrupted => Some(TurnStatus::Interrupted),
        ody_app_server_protocol::TurnStatus::InProgress => None,
    }
}
