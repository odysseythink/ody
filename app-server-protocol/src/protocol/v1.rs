...
pub struct InitializeResponse {
    ...
    /// Absolute path to the server's $ODY_HOME directory.
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [ody_protocol::protocol::PatchApplyBeginEvent]
    /// and [ody_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [ody_protocol::protocol::ExecCommandBeginEvent]
    /// and [ody_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
...
pub struct GetAuthStatusResponse {
    ...
    pub requires_odysseythink_auth: Option<bool>,
}
