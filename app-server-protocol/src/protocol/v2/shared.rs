...
use ody_protocol::config_types::ApprovalsReviewer as CoreApprovalsReviewer;
use ody_protocol::config_types::SandboxMode as CoreSandboxMode;
...
use ody_protocol::protocol::NonSteerableTurnKind as CoreNonSteerableTurnKind;
...
impl From<CoreOdyErrorInfo> for OdyErrorInfo {
    fn from(value: CoreOdyErrorInfo) -> Self {
        match value {
            CoreOdyErrorInfo::ContextWindowExceeded => OdyErrorInfo::ContextWindowExceeded,
            CoreOdyErrorInfo::UsageLimitExceeded => OdyErrorInfo::UsageLimitExceeded,
            CoreOdyErrorInfo::ServerOverloaded => OdyErrorInfo::ServerOverloaded,
            CoreOdyErrorInfo::CyberPolicy => OdyErrorInfo::CyberPolicy,
            CoreOdyErrorInfo::HttpConnectionFailed { http_status_code } => {
                OdyErrorInfo::HttpConnectionFailed { http_status_code }
            }
            CoreOdyErrorInfo::ResponseStreamConnectionFailed { http_status_code } => {
                OdyErrorInfo::ResponseStreamConnectionFailed { http_status_code }
            }
            CoreOdyErrorInfo::InternalServerError => OdyErrorInfo::InternalServerError,
            CoreOdyErrorInfo::Unauthorized => OdyErrorInfo::Unauthorized,
            CoreOdyErrorInfo::BadRequest => OdyErrorInfo::BadRequest,
            CoreOdyErrorInfo::ThreadRollbackFailed => OdyErrorInfo::ThreadRollbackFailed,
            CoreOdyErrorInfo::SandboxError => OdyErrorInfo::SandboxError,
            CoreOdyErrorInfo::ResponseStreamDisconnected { http_status_code } => {
                OdyErrorInfo::ResponseStreamDisconnected { http_status_code }
            }
            CoreOdyErrorInfo::ResponseTooManyFailedAttempts { http_status_code } => {
                OdyErrorInfo::ResponseTooManyFailedAttempts { http_status_code }
            }
            CoreOdyErrorInfo::ActiveTurnNotSteerable { turn_kind } => {
                OdyErrorInfo::ActiveTurnNotSteerable {
                    turn_kind: turn_kind.into(),
                }
            }
            CoreOdyErrorInfo::Other => OdyErrorInfo::Other,
        }
    }
}
