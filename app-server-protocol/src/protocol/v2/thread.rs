...
pub use ody_protocol::capabilities::CapabilityRootLocation;
pub use ody_protocol::capabilities::SelectedCapabilityRoot;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "ody_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
    ...
    /// This is for internal use only (e.g. Ody Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR ODY CLOUD - DO NOT USE.
...
impl From<ody_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: ody_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> ody_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => ody_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => ody_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `ody_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
