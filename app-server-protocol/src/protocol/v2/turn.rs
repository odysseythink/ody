...
use ody_protocol::user_input::TextElement as CoreTextElement;
...
pub struct TurnStartParams {
    ...
    /// Optional metadata to enrich Ody's ResponsesAPI turn metadata.
    ///
    /// Entries are flattened into the JSON string sent as
    /// `client_metadata["x-ody-turn-metadata"]` on ResponsesAPI HTTP and websocket requests.
    ///
