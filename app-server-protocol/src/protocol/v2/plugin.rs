...
use ody_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct SkillsUpgradeParams {
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct SkillsUpgradeResponse {
    pub name: String,
...
pub enum PluginAvailability {
    ...
    /// Ody app-server exposes `"AVAILABLE"` in its API; the alias keeps
