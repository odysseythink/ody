use super::OdyErrorInfo;
use super::ThreadItem;
use super::ThreadStatus;
use super::TurnStatus;
use ody_protocol::protocol::SessionSource as CoreSessionSource;
use ody_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use ody_protocol::protocol::ThreadSource as CoreThreadSource;
...
pub struct Thread {
    ...
    /// Origin of the thread (CLI, VSCode, ody exec, ody app-server, etc.).
