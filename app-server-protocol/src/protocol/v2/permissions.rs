...
use ody_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use ody_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use ody_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use ody_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use ody_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use ody_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> ody_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<ody_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: ody_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            ody_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            ody_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            ody_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
