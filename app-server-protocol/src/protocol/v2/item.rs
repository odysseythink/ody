...
use ody_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use ody_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use ody_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
use ody_protocol::items::AgentMessageContent as CoreAgentMessageContent;
...
use ody_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use ody_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
...
impl From<ody_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: ody_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<DynamicToolCallOutputContentItem>
    for ody_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
