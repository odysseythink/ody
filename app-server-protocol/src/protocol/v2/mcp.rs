...
use ody_protocol::items::McpToolCallError as CoreMcpToolCallError;
use ody_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use ody_protocol::mcp::McpServerInfo;
use ody_protocol::mcp::Resource as McpResource;
pub use ody_protocol::mcp::ResourceContent as McpResourceContent;
use ody_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use ody_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from ody_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> ody_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => ody_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => ody_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => ody_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active Ody turn when this elicitation was observed, if app-server could correlate one.
    ///
...
pub enum McpServerElicitationRequest {
    ...
    #[serde(rename = "odysseythink/form", rename_all = "camelCase")]
    #[ts(rename = "odysseythink/form", rename_all = "camelCase")]
    OpenAiForm {
        #[serde(rename = "_meta")]
        #[ts(rename = "_meta")]
        meta: Option<JsonValue>,
