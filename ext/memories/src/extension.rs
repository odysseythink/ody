...
/// Contributes Ody memory read-path prompt context and memory read tools.
...
pub(crate) struct MemoriesExtensionConfig {
    ...
    pub(crate) ody_home: AbsolutePathBuf,
}
...
impl ContextContributor for MemoriesExtension {
    fn contribute_thread_context<'a>(
        ...
        Box::pin(async move {
            ...
            build_memory_tool_developer_instructions(&config.ody_home)
                .await
...
impl ToolContributor for MemoriesExtension {
    fn tools(
        ...
        tools::memory_tools(
            LocalMemoriesBackend::from_ody_home(&config.ody_home),
