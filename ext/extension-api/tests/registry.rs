...
use ody_extension_api::ApprovalReviewContributor;
use ody_extension_api::ConfigContributor;
use ody_extension_api::ContextContributor;
use ody_extension_api::ContextualUserFragment;
...
use ody_protocol::items::HookPromptItem;
        ...
        fragments.extend(
            contributor
                .contribute_turn_context(TurnContextContributionInput {
                    thread_id: ody_protocol::ThreadId::default(),
