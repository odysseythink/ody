...
use ody_extension_api::ThreadIdleInput;
...
use ody_extension_api::TokenUsageContributor;
use ody_extension_api::ToolCallOutcome;
use ody_extension_api::ToolContributor;
use ody_extension_api::ToolFinishInput;
use ody_extension_api::ToolLifecycleContributor;
use ody_extension_api::ToolLifecycleFuture;
use ody_extension_api::TurnAbortInput;
    ...
    fn on_turn_error<'a>(&'a self, input: TurnErrorInput<'a>) -> ExtensionFuture<'a, ()> {
        Box::pin(async move {
            ...
            let reason = match input.error {
                OdyErrorInfo::UsageLimitExceeded => ActiveGoalStopReason::UsageLimit,
