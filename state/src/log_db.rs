...
//!
//! # async fn example(state_db: std::sync::Arc<ody_state::StateRuntime>) {
...
pub fn default_filter() -> Targets {
    Targets::new()
        ...
        .with_target("ody_otel.log_only", LevelFilter::OFF)
        .with_target("ody_otel.trace_safe", LevelFilter::OFF)
}
    ...
    S: tracing::Subscriber + for<'a> LookupSpan<'a>,
{
    ...
    fn on_event(&self, event: &Event<'_>, ctx: tracing_subscriber::layer::Context<'_, S>) {
        ...
        // were over 30% of retained logs in measured high-fanout Ody environments.
...
mod tests {
    ...
    fn temp_ody_home() -> std::path::PathBuf {
        std::env::temp_dir().join(format!("ody-state-log-db-{}", Uuid::new_v4()))
    }
